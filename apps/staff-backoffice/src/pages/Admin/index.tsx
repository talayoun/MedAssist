...
const s: Record<string, React.CSSProperties> = {
  ...
  editBtn: { marginLeft: 6, padding: '4px 10px', background: 'transparent', color: '#0D9488', border: '1.5px solid #0D9488', borderRadius: 6, fontSize: 12, cursor: 'pointer' },
  ...
  addBtn: { alignSelf: 'flex-start', background: 'rgba(13,148,136,0.08)', color: '#0F766E', border: '1px dashed #0D9488', borderRadius: 7, padding: '5px 10px', fontSize: 12, cursor: 'pointer' },
